  ...
  return (
    <div className="space-y-12 relative z-10">
      ...
      <div className="bg-white/[0.02] border border-white/5 rounded-3xl backdrop-blur-xl overflow-hidden shadow-2xl relative">
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-neutral-400 uppercase tracking-wider bg-white/[0.01] border-b border-white/5">
              <tr>
                ...
                <th className="px-8 py-5 font-semibold text-center">Units Sold</th>
                <th className="px-8 py-5 font-semibold text-right">Revenue</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/5">
              {productData.length === 0 ? (
                <tr>
                  <td colSpan={3} className="px-8 py-20 text-center text-neutral-400">
                ...
                productData.map((data, idx) => (
                  <tr key={idx} className="hover:bg-white/[0.03] transition-colors duration-200 group">
                    <td className="px-8 py-5 font-medium text-white group-hover:text-neutral-300 transition-colors">
                    ...
                    <td className="px-8 py-5 text-white text-center">
                    ...
                    <td className="px-8 py-5 text-right font-semibold text-white text-lg">
        ...
        {totalPages > 1 && (
          <div className="px-8 py-5 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4 bg-white/[0.01] relative z-10">
