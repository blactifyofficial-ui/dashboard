        ...
        <div className="p-6 space-y-3 relative z-10">
          {monthlyData.length === 0 ? (
            ...
            monthlyData.map((data, idx) => {
              ...
              return (
                <div key={idx} className="group relative bg-white/[0.02] border border-white/5 rounded-2xl overflow-hidden hover:bg-white/[0.04] transition-all duration-300 shadow-sm hover:shadow-xl">
